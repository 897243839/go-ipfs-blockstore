...
type Blockstore interface {
	...
	Get1(context.Context, cid.Cid) (blocks.Block, error)
...
func (bs *blockstore) Get1(ctx context.Context, k cid.Cid) (blocks.Block, error) {
	if !k.Defined() {
		logger.Error("undefined cid in blockstore")
		return nil, ipld.ErrNotFound{Cid: k}
	}
	...
	if bs.rehash.Load() {
		...
		return blocks.NewBlockWithCid1(bdata, rbcid)
	}
	return blocks.NewBlockWithCid1(bdata, k)
}
